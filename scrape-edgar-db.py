# https://kirksanalytics.com/kirks-blog/scraping-analyzing-sec-edgar-financial-statements-with-python-and-sql-part-i/
# 4 Feb 2022
...
folder_path = r"C:\sqlite\scrape-edgar-db\db"
